...
FEATURES = ['log_return_lag1', 'log_return_lag2', 'log_return_lag3', 'log_return_lag4', 'sign_return', 'sign_return_lag1', 'sign_return_lag2', 'momentum_filter_1', 'momentum_filter_2', 'momentum_filter_3', 'vader_sentiment_compound', 'log_return_lag5', 'sign_return_lag3', 'momentum_filter_4']
OPTUNA_TRIALS = 500
MODEL_PARAMS = {'max_depth': 8, 'num_leaves': 50, 'reg_alpha': 0.2, 'reg_lambda': 0.2}
ENSEMBLE_SIZE = 5
SMOOTHING_WINDOW = 3

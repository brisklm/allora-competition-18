...
FEATURES = ['log_return_lag1', 'log_return_lag2', 'log_return_lag3', 'log_return_lag4', 'sign_return', 'sign_return_lag1', 'sign_return_lag2', 'momentum_filter_1', 'momentum_filter_2', 'vader_sentiment_compound']
OPTUNA_TRIALS = 200
MODEL_PARAMS = {'max_depth': 6, 'num_leaves': 30, 'reg_alpha': 0.1, 'reg_lambda': 0.1}

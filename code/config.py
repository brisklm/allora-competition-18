...
FEATURES = ['log_return_lag1', 'log_return_lag2', 'log_return_lag3', 'log_return_lag4', 'sign_return', 'sign_return_lag1', 'momentum_filter_1', 'momentum_filter_2', 'momentum_filter_3', 'vader_sentiment_compound', 'vader_sentiment_pos', 'vader_sentiment_neg']
OPTUNA_TRIALS = 200
MODEL_PARAMS = {'max_depth': 10, 'num_leaves': 60, 'reg_alpha': 0.1, 'reg_lambda': 0.1}

...
FEATURES = ['log_return_lag1', 'log_return_lag2', 'log_return_lag3', 'sign_return', 'sign_return_lag1', 'momentum_filter_1', 'momentum_filter_2', 'vader_sentiment_compound']
OPTUNA_TRIALS = 300
MODEL_PARAMS = {'max_depth': 5, 'num_leaves': 15, 'reg_alpha': 0.2, 'reg_lambda': 0.2}

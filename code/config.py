...
FEATURES = ['log_return_lag1', 'log_return_lag2', 'log_return_lag3', 'log_return_lag4', 'sign_return', 'sign_return_lag1', 'momentum_filter_1', 'momentum_filter_2', 'vader_sentiment_compound', 'vader_sentiment_pos', 'vader_sentiment_neg']
OPTUNA_TRIALS = 300
MODEL_PARAMS = {'max_depth': 5, 'num_leaves': 31, 'reg_alpha': 0.5, 'reg_lambda': 0.5, 'min_child_samples': 20}
